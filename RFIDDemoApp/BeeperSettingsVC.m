...
#define ZT_VC_BEEPER_CELL_IDX_VOLUME                      1
#define ZT_VC_BEEPER_CELL_IDX_VOLUME_PICKER               2

#define ZT_VC_BEEPER_CELL_TAG_SLED_BEEPER                 0
#define ZT_VC_BEEPER_CELL_TAG_VOLUME                      1
#define ZT_VC_BEEPER_CELL_TAG_VOLUME_PICKER               2
...
- (void)createPreconfiguredOptionCells
{
    ...
    [m_cellSledBeeper setInfoNotice:@"Sled Beeper"];
    [m_cellVolumeLevel setInfoNotice:@"Volume"];
...
{
    BOOL sled_beeper = [m_LocalConfig currentBeeperEnable];
    return 1 + ((YES == sled_beeper) ? 1 : 1) + ((YES == isPickerShown) ? 1 : 0);
}
